...
namespace E_CommerceProject.Migrations
{
    ...
    [Migration("20250506052012_addRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Address", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.ShippingRegion", "Region")
                        .WithMany("Addresses")
                        .HasForeignKey("RegionId")
                        .IsRequired()
                        .HasConstraintName("FK_Addresses_ShippingRegions");

                    b.HasOne("E_CommerceProject.Data.User", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.BankFee", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.PaymentMethod", "PaymentMethod")
                        .WithMany("BankFees")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Cart", b =>
                {
                    b.HasOne("E_CommerceProject.Data.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("E_CommerceProject.Data.Models.Cart", "UserId")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.CartItem", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .IsRequired()
                        .HasConstraintName("FK_CartItems_Cart");

                    b.HasOne("E_CommerceProject.Data.Models.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Category", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Discount", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.DiscountType", "DiscountType")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Order", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.Discount", "Discount")
                        .WithMany("Orders")
                        .HasForeignKey("DiscountId")
                        .HasConstraintName("FK_Orders_Discounts");

                    b.HasOne("E_CommerceProject.Data.Models.Address", "ShippingAddress")
                        .WithMany("Orders")
                        .HasForeignKey("ShippingAddressId")
                        .IsRequired()
                        .HasConstraintName("FK_Orders_Addresses");

                    b.HasOne("E_CommerceProject.Data.Models.OrderStatus", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.OrderItem", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.PaymentDetail", b =>
                {
                    ...
                    b.HasOne("E_CommerceProject.Data.Models.PaymentStatus", "Status")
                        .WithMany("PaymentDetails")
                        .HasForeignKey("StatusId")
                        .IsRequired()
            ...
            modelBuilder.Entity("E_CommerceProject.Data.Models.Product", b =>
                {
                    b.HasOne("E_CommerceProject.Data.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_CommerceProject.Data.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
